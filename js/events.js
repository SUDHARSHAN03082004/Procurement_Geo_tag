...
function setupEventListeners() {
    ...
    // ── Supervisor page — attendance ─────────────────────────
    on('morningPunchBtn', 'click', handlePunch);
    on('eveningPunchBtn', 'click', handlePunch);
    ...
    on('shareBtn',        'click', shareReport);
    on('submitBtn',       'click', submitRecord);
